...
DEPLOY_ENV=prod
DEPLOY_HOST=ploneconf2024-alfigueiredo.tangrama.com.br
DEPLOY_PORT=22
DEPLOY_USER=plone
...
You need either a Ubuntu or Debian based system for ploneconf2024-alfigueiredo.tangrama.com.br, enable SSH, and install a supported version of Python 3 on that system.
...
prod:
  hosts:
    ploneconf2024-alfigueiredo.tangrama.com.br:
      ansible_user: root
      host: ploneconf2024-alfigueiredo
      hostname: ploneconf2024-alfigueiredo.tangrama.com.br
```
...
Deploy the stack defined in `devops/stacks/ploneconf2024-alfigueiredo.tangrama.com.br.yml` to the remote server with:
